...
<%
	...
	int maxSize = 2 * 1024 * 1024; // 최대 업로드될 파일의 크기 2MB
	
	// 현재 jsp페이지의 웹 애플리케이션상의 절대 경로를 구한다.
...
<%
	...
	String book_image = imageUp.getParameter("book_image");
	...
	// 월과 일이 한자리이면 앞에 0을 붙여 모두 2자리로 만든다.
	...
	// Form 화면에서 가져온 데이터를 DBBean에 보내기 위한 준비를 한다.
