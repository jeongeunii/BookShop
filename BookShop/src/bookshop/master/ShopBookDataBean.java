...
public class ShopBookDataBean {
	...
	public String toString() {
		return "[" + book_id + ", " + book_kind + ", " + book_title + ", " + book_price + ", " + book_count + ", "
				+ author + ", " + publishing_com + ", " + publishing_date + ", " + book_image + ", " + book_content
				+ ", " + discount_rate + ", " + reg_date + "]";
	}
